...
<p align="center" width="100%">
    ...
    <br>Figure 2 – Spatial partitioning : agents only consider flockmates that are positioned in the adjacent tiles to evaluate which of them are their neighbors<br>
</p>
